  ...
  return (
    <div className="min-h-screen flex bg-[#F9FAFB]">
        ...
        <div>
          ...
          <nav className="flex flex-col gap-1">
            {menuItems.map(item => (
              <button
                key={item.label}
                className={`text-left px-4 py-2 rounded-lg font-medium transition-all duration-150 ${router.pathname === item.path ? 'text-gray-900 font-bold bg-gray-100' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'}`}
      ...
      <main className="flex-1 flex flex-col py-10 pr-10">
        ...
        <div className="mt-8">
          {router.pathname === "/candidate/dashboard" && (
